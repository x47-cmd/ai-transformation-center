/* =========================================================
   AI Work - Enterprise Data Layer V2.0
...
AIW.Data = {
  ...
  departments: [
    { id: "biometric", name: "الأنظمة البيومترية", count: 7, maturity: 62 },
    { id: "smartgates", name: "البوابات الذكية", count: 6, maturity: 58 },
    { id: "users", name: "المستخدمون والصلاحيات", count: 7, maturity: 55 },
    { id: "security", name: "الأمن الرقمي", count: 5, maturity: 70 },
    { id: "analytics", name: "التحليلات والتقارير التنفيذية", count: 5, maturity: 52 }
  ],

  roadmap: [
    { phase: "المرحلة الأولى — حصر البيانات", year: "2026 Q1–Q2", progress: 20, activities: "حصر مصادر بيانات التسجيلات، سجلات الدخول، الصلاحيات، الأجهزة، وأخطاء الأنظمة البيومترية" },
    { phase: "المرحلة الثانية — بناء لوحات التحليل", year: "2026 Q3–Q4", progress: 35, activities: "إنشاء لوحات Power BI لمراقبة التسجيلات، الأخطاء، المستخدمين، والصلاحيات" },
    { phase: "المرحلة الثالثة — نماذج الذكاء الاصطناعي", year: "2027", progress: 50, activities: "تطبيق نماذج كشف الشذوذ، جودة البيانات، وتحليل سلوك المستخدمين" },
    { phase: "المرحلة الرابعة — الأتمتة والتنبيهات", year: "2028", progress: 65, activities: "تفعيل التنبيهات الذكية، إنشاء البلاغات تلقائياً، وربطها بإجراءات المراجعة" },
    { phase: "المرحلة الخامسة — المنصة التنفيذية", year: "2029", progress: 82, activities: "تطوير لوحة تنفيذية موحدة لقياس الأداء والمخاطر والتوصيات" },
    { phase: "المرحلة السادسة — النضج والاستدامة", year: "2030", progress: 100, activities: "تحسين مستمر، حوكمة النماذج، قياس العائد، وتوسيع الاستخدام حسب الحاجة" }
  ],

  projectHorizons: [
    { title: "مشاريع سريعة", type: "Quick Wins", examples: "لوحة أخطاء التسجيل، تحليل مدة الجلسات، مراقبة المستخدمين الأكثر نشاطاً، تقرير جودة البيانات" },
    { title: "مشاريع متوسطة المدى", type: "Medium Term", examples: "كشف السجلات المتعارضة، تحليل سلوك المستخدمين، مراقبة الصلاحيات، تحليل أداء البوابات" },
    { title: "مشاريع استراتيجية", type: "Strategic", examples: "محرك سلامة البيانات البيومترية، كشف إساءة استخدام الحسابات، لوحة القيادة التنفيذية، الصيانة التنبؤية للبوابات" }
  ],

  ideas: [
    ["الأنظمة البيومترية", "Biometric Data Integrity Engine", "عالية", "متوسطة", "6-9 أشهر", "متوسطة",
    ...
    ["الأنظمة البيومترية", "Biometric Registration Quality Monitor", "عالية", "سهلة", "3-5 أشهر", "منخفضة",
    ...
    ["الأنظمة البيومترية", "Duplicate Identity Detection Engine", "عالية", "متوسطة", "6-8 أشهر", "متوسطة",
    ...
    ["الأنظمة البيومترية", "Biometric Capture Quality AI", "متوسطة", "سهلة", "3-4 أشهر", "منخفضة",
    ...
    ["الأنظمة البيومترية", "Registration Error Root Cause Analyzer", "عالية", "متوسطة", "5-7 أشهر", "متوسطة",
    ...
    ["الأنظمة البيومترية", "Biometric Data Completeness Monitor", "متوسطة", "سهلة", "2-3 أشهر", "منخفضة",
    ...
    ["الأنظمة البيومترية", "Biometric Conflict Detection", "عالية", "متوسطة", "5-6 أشهر", "متوسطة",
    ...
    ["البوابات الذكية", "Smart Gate Performance Intelligence", "عالية", "متوسطة", "6-8 أشهر", "متوسطة",
    ...
    ["البوابات الذكية", "Smart Gate Predictive Maintenance", "عالية", "صعبة", "8-10 أشهر", "عالية",
    ...
    ["البوابات الذكية", "Passenger Processing Time Analytics", "متوسطة", "سهلة", "3-4 أشهر", "منخفضة",
    ...
    ["البوابات الذكية", "Smart Gate Error Pattern Detection", "عالية", "متوسطة", "5-6 أشهر", "متوسطة",
    ...
    ["البوابات الذكية", "Airport Gate Utilization Optimizer", "متوسطة", "متوسطة", "5-7 أشهر", "متوسطة",
    ...
    ["البوابات الذكية", "Smart Gate Availability Dashboard", "عالية", "سهلة", "3-4 أشهر", "منخفضة",
    ...
    ["المستخدمون والصلاحيات", "Credential Misuse Detection Engine", "عالية", "متوسطة", "6-8 أشهر", "متوسطة",
    ...
    ["المستخدمون والصلاحيات", "User Behaviour Intelligence Platform", "عالية", "متوسطة", "6-9 أشهر", "متوسطة",
    ...
    ["المستخدمون والصلاحيات", "Privilege Usage Analytics", "عالية", "سهلة", "3-5 أشهر", "منخفضة",
    ...
    ["المستخدمون والصلاحيات", "Long Session Anomaly Detection", "عالية", "سهلة", "3-4 أشهر", "منخفضة",
    ...
    ["المستخدمون والصلاحيات", "Multi-Device Account Usage Monitor", "متوسطة", "متوسطة", "4-6 أشهر", "متوسطة",
    ...
    ["المستخدمون والصلاحيات", "Sensitive Action Monitoring AI", "عالية", "متوسطة", "5-6 أشهر", "متوسطة",
    ...
    ["المستخدمون والصلاحيات", "Inactive Permission Risk Analyzer", "متوسطة", "سهلة", "2-3 أشهر", "منخفضة",
    ...
    ["الأمن الرقمي", "Access Log Anomaly Detection", "عالية", "متوسطة", "5-7 أشهر", "متوسطة",
    ...
    ["الأمن الرقمي", "AI Security Alert Prioritization", "عالية", "سهلة", "3-4 أشهر", "منخفضة",
    ...
    ["الأمن الرقمي", "Biometric System Risk Score", "عالية", "متوسطة", "5-6 أشهر", "متوسطة",
    ...
    ["الأمن الرقمي", "Unauthorized Pattern Detection", "عالية", "متوسطة", "6-8 أشهر", "متوسطة",
    ...
    ["الأمن الرقمي", "Audit Evidence Intelligence", "متوسطة", "سهلة", "3-5 أشهر", "منخفضة",
    ...
    ["التحليلات والتقارير التنفيذية", "Executive Biometric Intelligence Dashboard", "عالية", "متوسطة", "5-7 أشهر", "متوسطة",
    ...
    ["التحليلات والتقارير التنفيذية", "Airport Biometric Operations Dashboard", "عالية", "سهلة", "3-4 أشهر", "منخفضة",
    ...
    ["التحليلات والتقارير التنفيذية", "Registration Error Intelligence Dashboard", "عالية", "سهلة", "3-4 أشهر", "منخفضة",
    ...
    ["التحليلات والتقارير التنفيذية", "AI Recommendation Center", "متوسطة", "متوسطة", "5-6 أشهر", "متوسطة",
    ...
    ["التحليلات والتقارير التنفيذية", "Automated Executive Reporting", "متوسطة", "سهلة", "3-4 أشهر", "منخفضة",
  ...
  governance: [
    ...
    "توثيق جميع التنبيهات ونتائج المراجعة لأغراض التدقيق والتحسين المستمر",
    "تطبيق مبدأ أقل صلاحية ممكنة عند تحليل استخدام الصلاحيات",
    "مراجعة دورية للنماذج والمؤشرات لضمان العدالة والدقة وتقليل الإنذارات الخاطئة"
  ],

  risks: [
    { title: "جودة البيانات", level: "عالٍ", mitigation: "تطبيق قواعد جودة بيانات واضحة قبل تشغيل نماذج الذكاء الاصطناعي" },
    { title: "الخصوصية", level: "عالٍ", mitigation: "استخدام مؤشرات تشغيلية ومخرجات مراجعة دون عرض بيانات شخصية غير لازمة" },
    { title: "الإنذارات الخاطئة", level: "متوسط", mitigation: "اعتماد مراجعة بشرية وتدرج في مستويات التنبيه" },
    { title: "التكامل مع الأنظمة", level: "متوسط", mitigation: "البدء بلوحات قراءة وتحليل قبل أي تكامل تشغيلي عميق" },
    { title: "حوكمة الصلاحيات", level: "عالٍ", mitigation: "تحديد أدوار واضحة للمراجعة والاعتماد وتوثيق الإجراءات" }
  ],
  ...
  recommendations: [
    ...
    "تطبيق مبدأ Human-in-the-Loop في جميع الحالات الحساسة قبل اتخاذ أي إجراء",
